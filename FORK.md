...
[`quickfixgo/quickfix`](https://github.com/quickfixgo/quickfix). The module path
remains `github.com/quickfixgo/quickfix` so consumers can use this fork as a
drop-in replacement through a Go module `replace` directive.
