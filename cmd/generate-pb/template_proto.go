...
var ComponentProtoTemplate = template.Must(template.New("fix.component.proto").Funcs(templateFuncs).Parse(`// Code generated by generate-pb. DO NOT EDIT.
syntax = "proto3";
